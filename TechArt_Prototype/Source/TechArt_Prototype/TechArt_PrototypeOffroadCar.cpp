...
#include "TechArt_PrototypeOffroadCar.h"
#include "TechArt_PrototypeOffroadWheelFront.h"
#include "TechArt_PrototypeOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ATechArt_PrototypeOffroadCar::ATechArt_PrototypeOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTechArt_PrototypeOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTechArt_PrototypeOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTechArt_PrototypeOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTechArt_PrototypeOffroadWheelRear::StaticClass();
