...
#include "TechArt_PrototypeSportsCar.h"
#include "TechArt_PrototypeSportsWheelFront.h"
#include "TechArt_PrototypeSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATechArt_PrototypeSportsCar::ATechArt_PrototypeSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTechArt_PrototypeSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTechArt_PrototypeSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTechArt_PrototypeSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTechArt_PrototypeSportsWheelRear::StaticClass();
