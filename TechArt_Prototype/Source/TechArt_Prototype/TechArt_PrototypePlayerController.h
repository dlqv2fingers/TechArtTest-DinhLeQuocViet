...
#include "TechArt_PrototypePlayerController.generated.h"

class UInputMappingContext;
class ATechArt_PrototypePawn;
class UTechArt_PrototypeUI;
 ...
 */
UCLASS(abstract)
class TECHART_PROTOTYPE_API ATechArt_PrototypePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ATechArt_PrototypePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UTechArt_PrototypeUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UTechArt_PrototypeUI> VehicleUI;
